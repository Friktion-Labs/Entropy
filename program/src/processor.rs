...
use crate::state::{
    ...
    ONE_I80F48, PYTH_CONF_FILTER, QUOTE_INDEX, SERUM_TAKER_FEE, ZERO_I80F48,
};
use crate::utils::{gen_signer_key, gen_signer_seeds, pow_i80f48, serum_fees_mod};
...
impl Processor {
    ...
    fn init_mango_group(
        ...
        check_eq!(mango_group_ai.owner, program_id, EntropyErrorCode::InvalidGroupOwner)?;
        let rent = Rent::get()?;
        check!(
            rent.is_exempt(mango_group_ai.lamports(), size_of::<MangoGroup>()),
            EntropyErrorCode::GroupNotRentExempt
        )?;
        let mut mango_group: RefMut<MangoGroup> = MangoGroup::load_mut(mango_group_ai)?;
        check!(!mango_group.meta_data.is_initialized, EntropyErrorCode::Default)?;

        check!(
            gen_signer_key(signer_nonce, mango_group_ai.key, program_id)? == *signer_ai.key,
            EntropyErrorCode::InvalidSignerKey
        )?;
        ...
        check!(insurance_vault.is_initialized(), EntropyErrorCode::InvalidVault)?;
        check!(insurance_vault.delegate.is_none(), EntropyErrorCode::InvalidVault)?;
        check!(insurance_vault.close_authority.is_none(), EntropyErrorCode::InvalidVault)?;
        check_eq!(insurance_vault.owner, mango_group.signer_key, EntropyErrorCode::InvalidVault)?;
        check_eq!(&insurance_vault.mint, quote_mint_ai.key, EntropyErrorCode::InvalidVault)?;
        check_eq!(insurance_vault_ai.owner, &spl_token::ID, EntropyErrorCode::InvalidVault)?;
        mango_group.insurance_vault = *insurance_vault_ai.key;

        let fees_vault = Account::unpack(&fees_vault_ai.try_borrow_data()?)?;
        check!(fees_vault.is_initialized(), EntropyErrorCode::Default)?;
        check!(fees_vault.delegate.is_none(), EntropyErrorCode::InvalidVault)?;
        check!(fees_vault.close_authority.is_none(), EntropyErrorCode::InvalidVault)?;
        check_eq!(&fees_vault.mint, quote_mint_ai.key, EntropyErrorCode::InvalidVault)?;
        check_eq!(fees_vault_ai.owner, &spl_token::ID, EntropyErrorCode::InvalidVault)?;
        ...
        if msrm_vault_ai.key != &Pubkey::default() {
            ...
            check!(msrm_vault.is_initialized(), EntropyErrorCode::InvalidVault)?;
            check!(msrm_vault.delegate.is_none(), EntropyErrorCode::InvalidVault)?;
            check!(msrm_vault.close_authority.is_none(), EntropyErrorCode::InvalidVault)?;
            check_eq!(msrm_vault.owner, mango_group.signer_key, EntropyErrorCode::InvalidVault)?;
            check_eq!(&msrm_vault.mint, &msrm_token::ID, EntropyErrorCode::InvalidVault)?;
            check_eq!(msrm_vault_ai.owner, &spl_token::ID, EntropyErrorCode::InvalidVault)?;
        ...
        check!(admin_ai.is_signer, EntropyErrorCode::Default)?;
    ...
    fn init_mango_account(program_id: &Pubkey, accounts: &[AccountInfo]) -> MangoResult<()> {
        ...
        check!(owner_ai.is_signer, EntropyErrorCode::SignerNecessary)?;
        ...
        check_eq!(&mango_account_ai.owner, &program_id, EntropyErrorCode::InvalidOwner)?;
    ...
    fn add_spot_market(
        ...
        check!(admin_ai.is_signer, EntropyErrorCode::SignerNecessary)?;
        check_eq!(admin_ai.key, &mango_group.admin, EntropyErrorCode::InvalidAdminKey)?;
        ...
        check!(market_index < mango_group.num_oracles, EntropyErrorCode::InvalidParam)?;
        ...
        check!(mango_group.tokens[market_index].is_empty(), EntropyErrorCode::InvalidAccountState)?;
        ...
        if !mango_group.perp_markets[market_index].is_empty() {
            ...
            check!(mint.decimals == token_info.decimals, EntropyErrorCode::InvalidParam)?;
        }
        ...
        if mint_ai.key == &srm_token::ID {
            check!(mango_group.srm_vault == Pubkey::default(), EntropyErrorCode::Default)?;
    ...
    fn set_oracle(program_id: &Pubkey, accounts: &[AccountInfo], price: I80F48) -> MangoResult<()> {
        ...
        check!(admin_ai.is_signer, EntropyErrorCode::SignerNecessary)?;
        check_eq!(admin_ai.key, &mango_group.admin, EntropyErrorCode::InvalidAdminKey)?;
        check!(mango_group.find_oracle_index(oracle_ai.key).is_some(), EntropyErrorCode::Default)?;

        let oracle_type = determine_oracle_type(oracle_ai);
        check_eq!(oracle_type, OracleType::Stub, EntropyErrorCode::Default)?;
    ...
    fn add_perp_market(
        ...
        // params check
        check!(init_leverage >= ONE_I80F48, EntropyErrorCode::InvalidParam)?;
        check!(maint_leverage > init_leverage, EntropyErrorCode::InvalidParam)?;
        check!(maker_fee + taker_fee >= ZERO_I80F48, EntropyErrorCode::InvalidParam)?;
        check!(base_lot_size.is_positive(), EntropyErrorCode::InvalidParam)?;
        check!(quote_lot_size.is_positive(), EntropyErrorCode::InvalidParam)?;
        check!(!max_depth_bps.is_negative(), EntropyErrorCode::InvalidParam)?;
        check!(!rate.is_negative(), EntropyErrorCode::InvalidParam)?;
        check!(target_period_length > 0, EntropyErrorCode::InvalidParam)?;
        check!(exp <= 8 && exp > 0, EntropyErrorCode::InvalidParam)?;
        ...
        check!(mango_group.perp_markets[market_index].is_empty(), EntropyErrorCode::InvalidParam)?;
    ...
    fn create_perp_market(
        ...
        check!(!max_depth_bps.is_negative(), EntropyErrorCode::InvalidParam)?;
        if version == 1 {
            check!(max_depth_bps.int() == max_depth_bps, EntropyErrorCode::InvalidParam)?;
        }
        check!(!rate.is_negative(), EntropyErrorCode::InvalidParam)?;
        check!(target_period_length > 0, EntropyErrorCode::InvalidParam)?;
        check!(exp <= 8 && exp > 0, EntropyErrorCode::InvalidParam)?;
        ...
        check!(token_prog_ai.key == &spl_token::ID, EntropyErrorCode::InvalidProgramId)?;
        check!(
            system_prog_ai.key == &solana_program::system_program::id(),
            EntropyErrorCode::InvalidProgramId
        )?;
        check!(rent_ai.key == &solana_program::sysvar::rent::ID, EntropyErrorCode::InvalidAccount)?;

        let rent = Rent::get()?; // dynamically load rent sysvar

        let mut mango_group = MangoGroup::load_mut_checked(mango_group_ai, program_id)?;
        check!(&mango_group.signer_key == signer_ai.key, EntropyErrorCode::InvalidSignerKey)?;
        check!(admin_ai.is_signer, EntropyErrorCode::SignerNecessary)?;
        check_eq!(admin_ai.key, &mango_group.admin, EntropyErrorCode::InvalidAdminKey)?;
    ...
    fn deposit(program_id: &Pubkey, accounts: &[AccountInfo], quantity: u64) -> MangoResult<()> {
        ...
        check_eq!(token_prog_ai.key, &spl_token::ID, EntropyErrorCode::InvalidProgramId)?;

        let mango_group = MangoGroup::load_checked(mango_group_ai, program_id)?;
        let mut mango_account =
            MangoAccount::load_mut_checked(mango_account_ai, program_id, mango_group_ai.key)?;

        check!(!mango_account.is_bankrupt, EntropyErrorCode::Bankrupt)?;

        let mango_cache = MangoCache::load_checked(mango_cache_ai, program_id, &mango_group)?;

        let token_index = mango_group
            .find_root_bank_index(root_bank_ai.key)
            .ok_or(throw_err!(EntropyErrorCode::InvalidRootBank))?;

        // Find the node_bank pubkey in root_bank, if not found error
        let root_bank = RootBank::load_checked(root_bank_ai, program_id)?;
        check!(root_bank.node_banks.contains(node_bank_ai.key), EntropyErrorCode::InvalidNodeBank)?;
        let mut node_bank = NodeBank::load_mut_checked(node_bank_ai, program_id)?;
        check_eq!(&node_bank.vault, vault_ai.key, EntropyErrorCode::InvalidVault)?;
    ...
    fn change_rate_params(
        ...
        check!(
            ...
            EntropyErrorCode::InvalidRootBank
        )?;
    ...
    fn change_perp_market_params2(
        ...
        let market_index = mango_group
            ...
            .ok_or(throw_err!(EntropyErrorCode::InvalidMarket))?;
        ...
        // params check
        check!(init_asset_weight > ZERO_I80F48, EntropyErrorCode::InvalidParam)?;
        check!(maint_asset_weight > init_asset_weight, EntropyErrorCode::InvalidParam)?;
        // maint leverage may only increase to prevent unforeseen liquidations
        check!(maint_asset_weight >= info.maint_asset_weight, EntropyErrorCode::InvalidParam)?;
        ...
        check!(version == 0 || version == 1, EntropyErrorCode::InvalidParam)?;
            ...
            || lm_size_shift.is_some()
        {
            if version == 0 {
                ...
                check!(exp > 0 && exp <= 8, EntropyErrorCode::InvalidParam)?;
                ...
                let exp = exp.unwrap_or(perp_market.meta_data.extra_info[0]);
                let lm_size_shift = lm_size_shift.unwrap_or(perp_market.meta_data.extra_info[1]);
                check!(exp > 0 && exp <= 4, EntropyErrorCode::InvalidParam)?;
                perp_market.meta_data.extra_info[0] = exp;
                perp_market.meta_data.extra_info[1] = lm_size_shift;
                let mut lmi = &mut perp_market.liquidity_mining_info;
                let rate = rate.unwrap_or(lmi.rate);
            ...
            check!(version == perp_market.meta_data.version, EntropyErrorCode::InvalidParam)?;
        }
    ...
    fn cache_prices(program_id: &Pubkey, accounts: &[AccountInfo]) -> MangoResult<()> {
        ...
        // Substitute BTC^2-PERP oracle (Token index=0) with OracleAccountInfo corresponding to BTC-PERP (Token index=1)
        // TODO: This is brittle and requires a specific ordering and relationship between markets inside the group
        let mut substitute_oracle = &oracle_ais[0];
        for oracle_ai in oracle_ais.iter() {
            let oracle_index = mango_group.find_oracle_index(oracle_ai.key).ok_or(throw!())?;
            if oracle_index == 1 {
                substitute_oracle = oracle_ai;
            }
        }
        ...
        for oracle_ai in oracle_ais.iter() {
            ...
            if let Ok(mut price) = read_oracle(
                &mango_group,
                // oracle_info.unwrap().desired_token_index,
                // &oracle_info.unwrap().desired_account_info,
                sub_oracle_index,
                sub_oracle_ai,
            ) {
                if should_square {
    ...
    fn withdraw(
        ...
        check_eq!(&spl_token::ID, token_prog_ai.key, EntropyErrorCode::InvalidProgramId)?;

        let mango_group = MangoGroup::load_checked(mango_group_ai, program_id)?;
        check!(signer_ai.key == &mango_group.signer_key, EntropyErrorCode::InvalidSignerKey)?;

        let mut mango_account =
            MangoAccount::load_mut_checked(mango_account_ai, program_id, mango_group_ai.key)?;
        check!(&mango_account.owner == owner_ai.key, EntropyErrorCode::InvalidOwner)?;
        check!(!mango_account.is_bankrupt, EntropyErrorCode::Bankrupt)?;
        check!(owner_ai.is_signer, EntropyErrorCode::SignerNecessary)?;
        ...
        let token_index = mango_group
            .find_root_bank_index(root_bank_ai.key)
            .ok_or(throw_err!(EntropyErrorCode::InvalidToken))?;
        ...
        check!(native_deposit >= withdraw || allow_borrow, EntropyErrorCode::InsufficientFunds)?;
        checked_change_net(
            root_bank_cache,
            &mut node_bank,
            &mut mango_account,
        ...
        check!(health >= ZERO_I80F48, EntropyErrorCode::InsufficientFunds)?;
    ...
    fn init_spot_open_orders(program_id: &Pubkey, accounts: &[AccountInfo]) -> MangoResult<()> {
        ...
        let mut mango_account =
            MangoAccount::load_mut_checked(mango_account_ai, program_id, mango_group_ai.key)?;
        check!(&mango_account.owner == owner_ai.key, EntropyErrorCode::InvalidOwner)?;
        check!(owner_ai.is_signer, EntropyErrorCode::InvalidSignerKey)?;
        check!(!mango_account.is_bankrupt, EntropyErrorCode::Bankrupt)?;

        {
            ...
            check_eq!(open_orders.account_flags, 0, EntropyErrorCode::Default)?;
        }
    ...
    fn place_spot_order(
        ...
        check!(
            ...
            EntropyErrorCode::InvalidNodeBank
        )?;
        let mut base_node_bank = NodeBank::load_mut_checked(base_node_bank_ai, program_id)?;

        check_eq!(&base_node_bank.vault, base_vault_ai.key, EntropyErrorCode::InvalidVault)?;
        ...
        check_eq!(&quote_node_bank.vault, quote_vault_ai.key, EntropyErrorCode::InvalidVault)?;
        ...
        if mango_account.being_liquidated {
            if pre_health >= ZERO_I80F48 {
                ...
                return Err(throw_err!(EntropyErrorCode::BeingLiquidated));
            }
        }
        ...
        check!(post_allowed || post_locked <= pre_locked, EntropyErrorCode::InvalidParam)?;
        ...
        check!(
            ...
            EntropyErrorCode::InsufficientFunds
        )?;
    ...
    fn settle_funds(program_id: &Pubkey, accounts: &[AccountInfo]) -> MangoResult {
        ...
        let mut mango_account =
            MangoAccount::load_mut_checked(mango_account_ai, program_id, mango_group_ai.key)?;
        check!(owner_ai.key == &mango_account.owner, EntropyErrorCode::InvalidOwner)?;
        check!(owner_ai.is_signer, EntropyErrorCode::SignerNecessary)?;
        check!(!mango_account.is_bankrupt, EntropyErrorCode::Bankrupt)?;
        ...
        check!(post_base <= pre_base, EntropyErrorCode::MathError)?;
        check!(post_quote <= pre_quote, EntropyErrorCode::MathError)?;
    ...
    fn place_perp_order(
        ...
        check!(price > 0, EntropyErrorCode::InvalidParam)?;
        check!(quantity > 0, EntropyErrorCode::InvalidParam)?;
        ...
        check!(!mango_account.is_bankrupt, EntropyErrorCode::Bankrupt)?;
        check!(owner_ai.is_signer, EntropyErrorCode::SignerNecessary)?;
        check_eq!(&mango_account.owner, owner_ai.key, EntropyErrorCode::InvalidOwner)?;
        mango_account.check_open_orders(&mango_group, open_orders_ais)?;
    ...
    fn cancel_perp_order_by_client_id(
        ...
        let (order_id, side) = mango_account
            ...
            .ok_or(throw_err!(EntropyErrorCode::ClientIdNotFound))?;
        ...
        check_eq!(&order.owner, mango_account_ai.key, EntropyErrorCode::InvalidOrderId)?;
    ...
    fn cancel_perp_order(
        ...
        let side = mango_account
            ...
            .ok_or(throw_err!(EntropyErrorCode::InvalidOrderId))?;
        let mut book = Book::load_checked(program_id, bids_ai, asks_ai, &perp_market)?;
    ...
    fn cancel_all_perp_orders(
        ...
        let mut mango_account =
            MangoAccount::load_mut_checked(mango_account_ai, program_id, mango_group_ai.key)?;
        check!(!mango_account.is_bankrupt, EntropyErrorCode::Bankrupt)?;
        check!(owner_ai.is_signer, EntropyErrorCode::Default)?;
        check_eq!(&mango_account.owner, owner_ai.key, EntropyErrorCode::InvalidOwner)?;
    ...
    fn settle_pnl(
        ...
        check!(!mango_account_a.is_bankrupt, EntropyErrorCode::Bankrupt)?;

        let mut mango_account_b =
            MangoAccount::load_mut_checked(mango_account_b_ai, program_id, mango_group_ai.key)?;
        check!(!mango_account_b.is_bankrupt, EntropyErrorCode::Bankrupt)?;

        match mango_group.find_root_bank_index(root_bank_ai.key) {
            None => return Err(throw_err!(EntropyErrorCode::Default)),
            Some(i) => check!(i == QUOTE_INDEX, EntropyErrorCode::Default)?,
        }
        let root_bank = RootBank::load_checked(root_bank_ai, program_id)?;
        let mut node_bank = NodeBank::load_mut_checked(node_bank_ai, program_id)?;
        check!(root_bank.node_banks.contains(node_bank_ai.key), EntropyErrorCode::Default)?;
    ...
    fn settle_fees(program_id: &Pubkey, accounts: &[AccountInfo]) -> MangoResult<()> {
        ...
        check!(serum_fees_vault.is_initialized(), EntropyErrorCode::Default)?;
        check!(serum_fees_vault.delegate.is_none(), EntropyErrorCode::InvalidVault)?;
        check!(serum_fees_vault.close_authority.is_none(), EntropyErrorCode::InvalidVault)?;
        check_eq!(serum_fees_vault_ai.owner, &spl_token::ID, EntropyErrorCode::InvalidVault)?;

        check_eq!(token_prog_ai.key, &spl_token::ID, EntropyErrorCode::InvalidProgramId)?;

        let mango_group = MangoGroup::load_checked(mango_group_ai, program_id)?;
        check!(fees_vault_ai.key == &mango_group.fees_vault, EntropyErrorCode::InvalidVault)?;
        check!(signer_ai.key == &mango_group.signer_key, EntropyErrorCode::InvalidSignerKey)?;
        check!(
            *serum_fees_vault_ai.key == serum_fees_mod::id(),
            EntropyErrorCode::InvalidSerumVault
        )?;
        ...
        let mut node_bank = NodeBank::load_mut_checked(node_bank_ai, program_id)?;
        check!(root_bank.node_banks.contains(node_bank_ai.key), EntropyErrorCode::InvalidNodeBank)?;
        check!(bank_vault_ai.key == &node_bank.vault, EntropyErrorCode::InvalidVault)?;
        ...
        check!(pnl.is_negative(), EntropyErrorCode::Default)?;
        check!(perp_market.fees_accrued.is_positive(), EntropyErrorCode::Default)?;
        // check!(perp_market.serum_fees_accrued.is_positive(), EntropyErrorCode::Default)?;
    ...
    fn force_cancel_spot_orders(
        ...
        check!(!liqee_ma.is_bankrupt, EntropyErrorCode::Bankrupt)?;
        liqee_ma.check_open_orders(&mango_group, liqee_open_orders_ais)?;

        let market_index = mango_group.find_spot_market_index(spot_market_ai.key).unwrap();
        check!(liqee_ma.in_margin_basket[market_index], EntropyErrorCode::Default)?;
        ...
        if liqee_ma.being_liquidated {
            ...
            return Err(throw_err!(EntropyErrorCode::NotLiquidatable));
        } else {
        ...
        check!(post_base <= pre_base, EntropyErrorCode::Default)?;
        check!(post_quote <= pre_quote, EntropyErrorCode::Default)?;
    ...
    fn force_cancel_perp_orders(
        ...
        let market_index = mango_group.find_perp_market_index(perp_market_ai.key).unwrap();
        let perp_market_info = &mango_group.perp_markets[market_index];
        check!(!perp_market_info.is_empty(), EntropyErrorCode::InvalidMarket)?;
    ...
    fn liquidate_token_and_token(
        ...
        // parameter checks
        check!(max_liab_transfer.is_positive(), EntropyErrorCode::InvalidParam)?;
        ...
        check_eq!(liqor_ai.key, &liqor_ma.owner, EntropyErrorCode::InvalidOwner)?;
        check!(liqor_ai.is_signer, EntropyErrorCode::InvalidSignerKey)?;
        check!(!liqor_ma.is_bankrupt, EntropyErrorCode::Bankrupt)?;
        ...
        check!(asset_index != liab_index, EntropyErrorCode::InvalidParam)?;
        ...
        for i in 0..mango_group.num_oracles {
            if liqee_active_assets.perps[i] {
                check!(liqee_ma.perp_accounts[i].is_liquidatable(), EntropyErrorCode::Default)?;
            }
        }
        ...
        check!(liqee_ma.deposits[asset_index].is_positive(), EntropyErrorCode::Default)?;
        check!(liqee_ma.borrows[liab_index].is_positive(), EntropyErrorCode::Default)?;
        ...
        let (asset_fee, init_asset_weight) = if asset_index == QUOTE_INDEX {
            ...
            check!(!asset_info.is_empty(), EntropyErrorCode::InvalidMarket)?;
        ...
        let (liab_fee, init_liab_weight) = if liab_index == QUOTE_INDEX {
            ...
            check!(!liab_info.is_empty(), EntropyErrorCode::InvalidMarket)?;
        ...
        check!(liqor_health >= ZERO_I80F48, EntropyErrorCode::InsufficientFunds)?;
    ...
    fn liquidate_token_and_perp(
        ...
        check!(max_liab_transfer.is_positive(), EntropyErrorCode::InvalidParam)?;
        check!(asset_type != liab_type, EntropyErrorCode::InvalidParam)?;
        ...
        if asset_type == AssetType::Token {
            ...
            check!(liqee_ma.deposits[asset_index].is_positive(), EntropyErrorCode::Default)?;
            check!(liab_index != QUOTE_INDEX, EntropyErrorCode::Default)?;
            check!(
            ...
            check!(
                liqee_ma.perp_accounts[liab_index].base_position == 0,
                EntropyErrorCode::Default
            )?;
            check!(native_borrows.is_positive(), EntropyErrorCode::Default)?;
            ...
            check!(liqee_ma.borrows[liab_index].is_positive(), EntropyErrorCode::Default)?;
            check!(asset_index != QUOTE_INDEX, EntropyErrorCode::Default)?;
            ...
            check!(native_deposits.is_positive(), EntropyErrorCode::Default)?;
    ...
    fn liquidate_perp_market(
        ...
        check!(base_transfer_request != 0, EntropyErrorCode::InvalidParam)?;
        const NUM_FIXED: usize = 7;
        let accounts = array_ref![accounts, 0, NUM_FIXED + 2 * MAX_PAIRS];
        let (fixed_ais, liqee_open_orders_ais, liqor_open_orders_ais) =
            array_refs![accounts, NUM_FIXED, MAX_PAIRS, MAX_PAIRS];
        ...
        check!(!pmi.is_empty(), EntropyErrorCode::InvalidMarket)?;
    ...
    fn resolve_perp_bankruptcy(
        ...
        // Do parameter checks
        check!(liab_index < QUOTE_INDEX, EntropyErrorCode::InvalidParam)?;
        check!(max_liab_transfer.is_positive(), EntropyErrorCode::InvalidParam)?;
        ...
        let mut liqee_ma =
            MangoAccount::load_mut_checked(liqee_mango_account_ai, program_id, mango_group_ai.key)?;
        check!(liqee_ma.is_bankrupt, EntropyErrorCode::Default)?;
        ...
        check!(root_bank.node_banks.contains(node_bank_ai.key), EntropyErrorCode::InvalidNodeBank)?;
        let mut node_bank = NodeBank::load_mut_checked(node_bank_ai, program_id)?;
        check!(vault_ai.key == &node_bank.vault, EntropyErrorCode::InvalidVault)?;
        ...
        let socialized_loss =
            if liab_transfer_u64 == insurance_vault.amount && quote_position.is_negative() {
                ...
                check!(
                    ...
                    EntropyErrorCode::InvalidMarket
                )?;
                let mut perp_market =
                    PerpMarket::load_mut_checked(perp_market_ai, program_id, mango_group_ai.key)?;
    ...
    fn update_root_bank(program_id: &Pubkey, accounts: &[AccountInfo]) -> MangoResult<()> {
        ...
        let mut root_bank = RootBank::load_mut_checked(&root_bank_ai, program_id)?;
        check_eq!(root_bank.num_node_banks, node_bank_ais.len(), EntropyErrorCode::Default)?;
    ...
    fn redeem_mngo(program_id: &Pubkey, accounts: &[AccountInfo]) -> MangoResult<()> {
        ...
        check_eq!(&mngo_node_bank.vault, mngo_bank_vault_ai.key, EntropyErrorCode::InvalidVault)?;

        let perp_market = PerpMarket::load_checked(perp_market_ai, program_id, mango_group_ai.key)?;
        check!(mngo_perp_vault_ai.key == &perp_market.mngo_vault, EntropyErrorCode::InvalidVault)?;
    ...
    fn deposit_msrm(
        ...
        let mango_group = MangoGroup::load_checked(mango_group_ai, program_id)?;
        check!(msrm_vault_ai.key == &mango_group.msrm_vault, EntropyErrorCode::InvalidVault)?;
    ...
    fn withdraw_msrm(
        ...
        check!(mango_account.msrm_amount >= quantity, EntropyErrorCode::InsufficientFunds)?;
    ...
    fn init_advanced_orders(program_id: &Pubkey, accounts: &[AccountInfo]) -> MangoResult<()> {
        ...
        check!(&pda_address == advanced_orders_ai.key, EntropyErrorCode::InvalidAccount)?;
    ...
    fn add_perp_trigger_order(
        ...
        check!(price.is_positive(), EntropyErrorCode::InvalidParam)?;
        check!(quantity.is_positive(), EntropyErrorCode::InvalidParam)?;
        check!(trigger_price.is_positive(), EntropyErrorCode::InvalidParam)?; // Is this necessary?
        ...
        check!(
            ...
            EntropyErrorCode::InsufficientHealth
        )?;
        mango_account.being_liquidated = false;
        ...
        Err(throw_err!(EntropyErrorCode::OutOfSpace))
    }
    ...
    fn remove_advanced_order(
        ...
        check!(order_index < MAX_ADVANCED_ORDERS, EntropyErrorCode::InvalidParam)?;
    ...
    fn execute_perp_trigger_order(
        ...
        check!(order.is_active, EntropyErrorCode::InvalidParam)?;
        check!(
        ...
        match order.trigger_condition {
            TriggerCondition::Above => {
                check!(price >= order.trigger_price, EntropyErrorCode::TriggerConditionFalse)?;
            }
    ...
    pub fn process(program_id: &Pubkey, accounts: &[AccountInfo], data: &[u8]) -> MangoResult {
        ...
        match instruction {
            ...
            MangoInstruction::CancelPerpOrderByClientId { client_order_id, invalid_id_ok } => {
                ...
                if invalid_id_ok {
                    if let Err(EntropyError::EntropyErrorCode { mango_error_code, .. }) = result {
                        if mango_error_code == EntropyErrorCode::InvalidOrderId
                            || mango_error_code == EntropyErrorCode::ClientIdNotFound
                        {
                            return Ok(());
                        }
                    }
...
fn init_root_bank(
    ...
    check!(vault.is_initialized(), EntropyErrorCode::InvalidVault)?;
    ...
    check_eq!(vault.owner, mango_group.signer_key, EntropyErrorCode::InvalidVault)?;
    check_eq!(&vault.mint, mint_ai.key, EntropyErrorCode::InvalidVault)?;
    check_eq!(vault_ai.owner, &spl_token::id(), EntropyErrorCode::InvalidVault)?;
...
fn get_switchboard_value(oracle_ai: &AccountInfo) -> MangoResult<I80F48> {
    let temp_decimal: f64 =
        AggregatorAccountData::new(oracle_ai)?.get_result()?.try_into().unwrap();
        ...
        match oracle_type {
            OracleType::Pyth => {
                ...
                if price_account.agg.status != PriceStatus::Trading {
                    ...
                    return Err(throw_err!(EntropyErrorCode::InvalidOraclePrice));
            ...
            OracleType::Switchboard => {
                ...
                let mut value = I80F48::from_num(result.result.result);
            ...
            OracleType::Unknown => return Err(throw_err!(EntropyErrorCode::InvalidOracleType)),
        },
        1 as u8,
    );
...
fn checked_sub_net(
    ...
    check!(
        ...
        EntropyErrorCode::InsufficientLiquidity
    )
}
...
fn seed_and_create_pda<'a>(
    ...
    check!(&pda_address == pda_account.key, EntropyErrorCode::InvalidAccount)?;
    create_pda_account(
        funder,
        rent,
        space,
